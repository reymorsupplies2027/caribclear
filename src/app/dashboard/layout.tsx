...
import {
  LayoutDashboard, Ship, FolderLock, Calculator, Search, ClipboardCheck, Users, ReceiptText, Settings, Globe2, Bell, LogOut, Menu, X, FileText, BarChart3, Scale, Wrench, Send,
} from 'lucide-react';
...
const NAV = [
  ...
  { href: '/dashboard/e-filing', label: 'e-Filing', icon: Send },
